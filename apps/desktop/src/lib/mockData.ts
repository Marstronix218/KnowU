  ...
  recommendations: [
    {
      ...
      evidence: "Tauri documentation, Xcode, and the KnowU repository were your strongest recent cluster.",
...
export const mockProfile: ProfileData = {
  summary:
    "You are building KnowU, a memory-efficient personal AI agent. Your recent work is concentrated on local-first architecture, selective memory retrieval, and measurable context reduction.",
  sections: [
    {
      id: "projects",
