    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let state = AppState {
                ...
                memory: memory::EverOSMemoryService::default(),
                analytics: analytics::SnowflakeAnalyticsService::default(),
            ...
            let show = MenuItem::with_id(app, "show", "Show KnowU", true, None::<&str>)?;
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sync_profile_memories,
            commands::seed_demo_memories,
