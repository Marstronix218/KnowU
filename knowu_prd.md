# KnowU — Software Requirements Document
...
KnowU consists of five parts working together on the user's machine:
...
| FR-54 | Retain the editable generated profile and preserved user corrections until the user deletes them or invokes single-action deletion of all KnowU data. | Must |
